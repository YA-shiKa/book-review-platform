...
const Dashboard = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://media.istockphoto.com/id/587536078/photo/books-on-grunge-wooden-table-desk-shelf-in-library-back.jpg?s=612x612&w=0&k=20&c=E5IGL27uEBpnGMHTVX4700dmRi322n1Ump5gHKBiL-s=')",
